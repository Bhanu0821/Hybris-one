...
public class CartTotalExceedsEvent extends AbstractCommerceUserEvent {

    private AbstractOrderModel cart;

    public CartTotalExceedsEvent(final AbstractOrderModel cart, final BaseStoreModel baseStore,
